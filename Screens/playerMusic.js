        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={styles.mainContainer}>
                ...
                <View style={styles._SliderView}>
                    ...
                    <Image source={require('../assets/clock.png')} style={{height:18,width:18,marginLeft:8}}/>
                </View>
                </View>
                <View style={styles.musicControl}>

                    <View style={styles._skipPreviousView}>
                        <TouchableOpacity onPress={()=>{}}><Image source={require('../assets/previous.png')} style={styles._skipPreviousButton} /></TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.toggleButtonView}>
                        <TouchableOpacity onPress={()=>toggleHandler(url)}><Image source={isPlaying ? require('../assets/pause.png') : require('../assets/play-button.png')} style={styles.toggleButton} /></TouchableOpacity>
                    </View>
                    ...
                    <View style={styles._skipPreviousView}>
                        <TouchableOpacity onPress={()=>{navigation.navigate("ProfileScreen")}}><Image source={require('../assets/next-button.png')} style={styles._skipNextButton} /></TouchableOpacity>
                    </View>
